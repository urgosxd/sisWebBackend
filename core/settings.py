...
DATABASES = {
        'default':dj_database_url.config(default="mysql://uzmduhmy_josue:Admin123321Admin@single-5922.banahosting.com:3306/uzmduhmy_django_mysqlSisWebBackend", conn_max_age=600),
        }
